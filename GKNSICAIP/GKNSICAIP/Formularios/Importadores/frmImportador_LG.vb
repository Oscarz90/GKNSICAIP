...
#Region "Eventos controles"
    Private Sub frmImportador_LG_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        Cargar_Tabla(False)
...
#Region "Metodos"
    ...
    Private Sub CargarElementoSeleccionado(ByVal vIndice_Fila_Seleccioada As Integer)
        oLider = New Lider() With {.cve_lider = vIndice_Fila_Seleccioada}
        oLider.Cargar()
    End Sub
#End Region
