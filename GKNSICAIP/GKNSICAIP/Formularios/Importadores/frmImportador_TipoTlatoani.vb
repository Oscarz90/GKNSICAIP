...
#Region "Eventos de controles"
    Private Sub frmImportador_TipoTlatoani_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cargar_Tabla(False)
...
#Region "Metodos"
    ...
    Private Sub CargarElementoSeleccionado(ByVal vIndice_Fila_Seleccioada As Integer)
        oDetalle = New Detalle
        oDetalle.Cve_Detalle = vIndice_Fila_Seleccioada
        oDetalle.Cargar()
    End Sub
