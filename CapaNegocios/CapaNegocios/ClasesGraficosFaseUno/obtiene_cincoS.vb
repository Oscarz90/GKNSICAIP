...
#Region "Metodos obtener oee"
    'Planta
    Public Function obtiene_cincos_planta_mes() As DataTable
    ...
    End Function
    'Cadena Valor
    Public Function obtiene_cincos_cadena_valor_mes() As DataTable
        Dim obj As DataTable
        Using scope As New TransactionScope
            Try
    ...
    End Function
    'Componente
    Public Function obtiene_cincos_componente_mes() As DataTable
        Dim obj As DataTable
        Using scope As New TransactionScope
            Try
    ...
    End Function
    'Linea
    Public Function obtiene_cincos_linea_mes() As DataTable
        Dim obj As DataTable
        Using scope As New TransactionScope
            Try
    ...
    End Function
    'Equipo
    Public Function obtiene_cincos_equipo_mes() As DataTable
        Dim obj As DataTable
        Using scope As New TransactionScope
            Try
        ...
        End Using
    End Function
    Public Function obtiene_cincos_equipo_linea_mes() As DataTable
        Dim obj As DataTable
        Using scope As New TransactionScope
            Try
