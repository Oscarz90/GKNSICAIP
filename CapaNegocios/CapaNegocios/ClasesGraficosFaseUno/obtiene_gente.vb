    ...
    Public Function obtiene_gente_planta_dia() As DataTable
        ...
        Using scope As New TransactionScope
            Try
                ...
                vComando.CommandText = "obtiene_gente_planta_dia"
    ...
    Public Function obtiene_gente_planta_mes() As DataTable
        ...
        Using scope As New TransactionScope
            Try
                Dim vComando As New SqlClient.SqlCommand
                vComando.CommandType = CommandType.StoredProcedure
                vComando.CommandText = "obtiene_gente_planta_mes"
                vComando.Parameters.Add("@fecha_inicial", SqlDbType.DateTime).Value = Me.vfecha_inicial
                vComando.Parameters.Add("@fecha_final", SqlDbType.DateTime).Value = Me.vfecha_final
                vComando.Parameters.Add("@bandera", SqlDbType.Int).Value = Me.vbandera
                obj = oBD.EjecutaCommando(vComando)
    ...
    Public Function obtiene_gente_cadena_valor_dia() As DataTable
        ...
        Using scope As New TransactionScope
            Try
                Dim vComando As New SqlClient.SqlCommand
                vComando.CommandType = CommandType.StoredProcedure
                vComando.CommandText = "obtiene_gente_cadena_valor_dia"
    ...
    Public Function obtiene_gente_cadena_valor_mes() As DataTable
        ...
        Using scope As New TransactionScope
            Try
                Dim vComando As New SqlClient.SqlCommand
                vComando.CommandType = CommandType.StoredProcedure
                vComando.CommandText = "obtiene_gente_cadena_valor_mes"
                vComando.Parameters.Add("@cve_cadena_valor", SqlDbType.BigInt).Value = Me.vcve_cadena_valor
                vComando.Parameters.Add("@fecha_inicial", SqlDbType.DateTime).Value = Me.vfecha_inicial
                vComando.Parameters.Add("@fecha_final", SqlDbType.DateTime).Value = Me.vfecha_final
                vComando.Parameters.Add("@bandera", SqlDbType.Int).Value = Me.vbandera
    ...
    Public Function obtiene_gente_componente_dia() As DataTable
        ...
        Using scope As New TransactionScope
            Try
                Dim vComando As New SqlClient.SqlCommand
                vComando.CommandType = CommandType.StoredProcedure
                vComando.CommandText = "obtiene_gente_componente_dia"
    ...
    Public Function obtiene_gente_componente_mes() As DataTable
        ...
        Using scope As New TransactionScope
            Try
                Dim vComando As New SqlClient.SqlCommand
                vComando.CommandType = CommandType.StoredProcedure
                vComando.CommandText = "obtiene_gente_componente_mes"
                vComando.Parameters.Add("@cve_componente", SqlDbType.BigInt).Value = Me.vcve_componente
                vComando.Parameters.Add("@fecha_inicial", SqlDbType.DateTime).Value = Me.vfecha_inicial
                vComando.Parameters.Add("@fecha_final", SqlDbType.DateTime).Value = Me.vfecha_final
                vComando.Parameters.Add("@bandera", SqlDbType.Int).Value = Me.vbandera
    ...
    Public Function obtiene_gente_linea_dia() As DataTable
        ...
        Using scope As New TransactionScope
            Try
                Dim vComando As New SqlClient.SqlCommand
                vComando.CommandType = CommandType.StoredProcedure
                vComando.CommandText = "obtiene_gente_linea_dia"
